...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server"><br />
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 style="color:rgb(148, 148, 148)">City Add Edit Page</h3>
            </div>
        </div>
        <br />
        <table>
            ...
            <tr>
                ...
                <td class="auto-style2">:</td>
                <td class="auto-style7">
                    <asp:TextBox runat="server" ID="txtCityName" CssClass="from form-control" Width="300px" />
                </td>
                <%--<td>
            ...
            <tr>
                <td style="color: red" class="auto-style6"></td>
                <td class="auto-style5">STD Code</td>
                <td class="auto-style2">:</td>
                <td class="auto-style7">
                    <asp:TextBox runat="server" ID="txtSTDCode" CssClass="from form-control" Width="300px" />
                </td>
                <%--<td>
            ...
            <tr>
                ...
                <td class="auto-style2">:</td>
                <td class="auto-style7">
                    <asp:TextBox runat="server" ID="txtPinCode" CssClass="from form-control" Width="300px" />
                </td>
                <%--<td>
                    <asp:RequiredFieldValidator ID="rfvCountryCode"  runat="server" Display="Dynamic" ErrorMessage="Enter Country Code" ControlToValidate="txtCountryCode" ValidationGroup="Save" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>--%>
